<%inherit file="base.mako" />\
  ...
  <div style="box-sizing: border-box; max-width: 650px; margin: 20px auto; padding: 20px 25px; background-color: #fff; box-shadow: 0 1px 2px #bbb;">
    ...
    <p style="margin-bottom: 0;">Please <a style="color: #090;" href="${request.route_url("account_verify_email", _scheme="https", _query={"user_id": user.id, "email_address": email_address, "token": email_token})}">click here</a> to verify your e-mail address.</p>
  </div>
