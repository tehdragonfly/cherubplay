...
<%block name="heading">Directory</%block>
    <section class="tile2">
      ...
      <p>The directory is a new section where you can post roleplay requests and answer other people's reqests. Unlike the standard prompt and anwer modes on the homepage, prompts in the directory stay up when you're not online and aren't taken down when people answer them. In addition, there's a tag system which allows you to search for or blacklist tags.</p>
