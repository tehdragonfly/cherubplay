...
% endif
      <p><textarea id="prompt_text" name="prompt_text" placeholder="Enter your prompt..." required style="color: ${request.POST.get("prompt_colour") or "#" + prompt.colour};">${request.POST.get("prompt_text") or prompt.text}</textarea></p>
% if error == "blank_text":
